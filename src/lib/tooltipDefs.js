...
export const TIPS = {
  ...
  score: {
    ...
    levels: [
      ...
      { range: '28–42',  label: 'Negative', color: C.orange, desc: 'More bearish signals — unfavorable backdrop for longs.' },
      { range: '0–28',   label: 'Bearish',  color: C.red,    desc: 'Broad signal weakness — high probability of continued underperformance.' },
    ],
