...
export const DEMO_MARKET_DATA = {
  AAPL: {
    ...
    shortInterest: { data: { shortInterest: 118_400_000, avgDailyVolume: 62_000_000, daysToCover: 1.9, date: '2026-06-14' }, stale: true },
  ...
  NVDA: {
    ...
    metrics:       { data: { metric: { marketCapitalization: 2150, peNormalizedAnnual: 68.4, peBasicExclExtraTTM: 68.4, epsGrowthTTMYoy: 112.5, epsGrowth3Y: 84.2, '50DayMovingAverage': 845.20, '200DayMovingAverage': 712.80, '52WeekHigh': 974.00, '52WeekLow': 460.30, beta: 1.93 } }, stale: true },
    news:          { data: [], stale: true },
    shortInterest: { data: { shortInterest: 214_600_000, avgDailyVolume: 38_500_000, daysToCover: 5.6, date: '2026-06-14' }, stale: true },
  ...
  TSLA: {
    ...
    metrics:       { data: { metric: { marketCapitalization: 795, peNormalizedAnnual: 58.7, peBasicExclExtraTTM: 58.7, epsGrowthTTMYoy: 14.2, epsGrowth3Y: 62.1, '50DayMovingAverage': 255.40, '200DayMovingAverage': 231.10, '52WeekHigh': 299.29, '52WeekLow': 138.80, beta: 2.31 } }, stale: true },
    news:          { data: [], stale: true },
    shortInterest: { data: { shortInterest: 98_200_000, avgDailyVolume: 95_000_000, daysToCover: 1.0, date: '2026-06-14' }, stale: true },
  ...
  AMZN: {
    ...
    news:          { data: [], stale: true },
    shortInterest: { data: { shortInterest: 42_800_000, avgDailyVolume: 35_800_000, daysToCover: 1.2, date: '2026-06-14' }, stale: true },
  ...
  MSFT: {
    ...
    news:          { data: [], stale: true },
    shortInterest: { data: { shortInterest: 38_100_000, avgDailyVolume: 22_400_000, daysToCover: 1.7, date: '2026-06-14' }, stale: true },
